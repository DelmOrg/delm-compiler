...
update msg global model =
    case msg of
        ...
        Transfer address amount ->
            ...
            in
            ( [ ( global.msg.sender /= zeroAddress, "ERC721: transfer from the zero address" )
              , ( address /= zeroAddress, "ERC721: transfer to the zero address" )
              , ( senderBalance >= amount, "ERC721: transfer amount exceeds balance" )
              , ( amount > 0, "ERC721: amount should be positive" )
              ]
            , { model
                | balances =
            ...
            let
                ...
                allowances =
                    Mapping.insert global.msg.sender
                        ...
                        model.allowances
            in
            ( [ ( global.msg.sender /= zeroAddress, "ERC721: approve from the zero address" )
              , ( spender /= zeroAddress, "ERC721: approve to the zero address" )
              ]
            ...
            let
                ...
                allowances =
                    Mapping.insert sender
                        ...
                        model.allowances
            in
            ( [ ( sender /= zeroAddress, "ERC721: transfer from the zero address" )
              , ( recipient /= zeroAddress, "ERC721: transfer to the zero address" )
              , ( senderBalance >= amount, "ERC721: transfer amount exceeds balance" )
              , ( allowedBalance >= amount, "ERC721: transfer amount exceeds allowance" )
              , ( amount > 0, "ERC721: amount should be positive" )
              ]
            , { model
